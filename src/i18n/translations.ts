...
export const translations = {
  en: {
    ...
    hero: {
      ...
      trust: [
        "No Age Limit",
        "Separate Classes for Male & Female",
      ...
      rows: [
        {
          label: "1 Course",
          price: "₹300/mo",
          desc: "Choose any single course from the 9 available.",
        },
        {
          label: "2, 3, or 4 Courses",
          price: "₹300/mo",
          desc: "Study multiple courses simultaneously.",
        },
        {
          label: "All 9 Courses",
          price: "₹300/mo",
          desc: "Full access to Dars-e-Nizami and all other courses!",
        },
      ],
      coursesListTitle: "The 9 Courses Included:",
      coursesList: [
        "Dars-e-Nizami (Aalim/Aalima)",
        "Tajweed",
        "Basic Urdu",
        "Deeniyat",
        "Qirat",
    ...
    courses: {
      ...
      list: [
        {
          name: "Dars-e-Nizami (Aalimiyat)",
          desc: "Full Aalim & Aalima course. Daily 2-hour class, 3 batch timings (morning/afternoon/evening).",
          duration: "5 Years",
          fee: "₹300/mo",
        },
        {
          name: "Muftiya & Mufti Course",
          desc: "Takhassus fil Fiqh — for graduates of Aalimiyat from a Sunni institute. Online live classes.",
          duration: "2 Years",
          fee: "₹500/mo",
        },
        {
          name: "Muballiga Course (Females)",
          desc: "Complete Deeni training for sisters by Aalima & Muftiya teachers — 1 hour daily, flexible timing.",
          duration: "2 Years",
          fee: "₹300/mo",
        },
        {
          name: "Safar-e-Hajj & Umrah",
          desc: "Complete Hajj & Umrah masail with 14+ topics. Live class on Teachmint + recordings.",
          duration: "1 Month",
          fee: "₹300",
        },
        {
          name: "Online Kids Special Course",
          desc: "For boys & girls aged 5–13. Qur'an, Arbi, Urdu, Namaz, Dua, Sunnatein, Drawing & more.",
          duration: "6 Months",
          fee: "₹350/mo",
        },
        {
          name: "Tajweed Course",
          desc: "Master the proper recitation of the Holy Quran with makharij.",
          duration: "6 Months",
          fee: "₹300/mo",
        },
        {
          name: "Urdu Reading & Writing",
          desc: "Daily 1-hour class, weekly quiz games & winner prizes. Recordings available.",
          duration: "3 Months",
          fee: "₹300/mo",
        },
        {
          name: "Deeniyat Course",
          desc: "Essential Islamic teachings for daily life — fardh ulooms.",
          duration: "10 Months",
          fee: "₹300/mo",
        },
        {
          name: "Qirat Course",
          desc: "Beautiful Quranic recitation. Special Dastar awarded on completion.",
          duration: "1 Year",
          fee: "₹300/mo",
        },
        {
          name: "English Speaking",
          desc: "Confident English communication for global Muslims.",
          duration: "1–2 Years",
          fee: "₹300/mo",
        },
        {
          name: "Naat, Hamd & Bayan",
          desc: "Art of devotional poetry, taqreer and oration.",
          duration: "6 Months",
          fee: "₹300/mo",
        },
        {
          name: "Khatme Nubuwwat ﷺ",
          desc: "Defending the finality of Prophethood ﷺ.",
          duration: "6 Months",
          fee: "₹300/mo",
        },
        {
          name: "Indian Constitution",
          desc: "Civic knowledge for every responsible Muslim.",
          duration: "1 Year",
          fee: "₹300/mo",
        },
      ],
    ...
    why: {
      ...
      subtitle:
        "Let us show you. When you enroll in any online course at Madrasa E Gulaaman E Mustafa ﷺ, you get more than just education — you get a complete learning experience combining authentic Deeni Taleem with modern technology!",
      categories: {
    ...
    posters: {
      kicker: "Official Posters",
      title: "Course Announcements",
      desc: "Tap any poster to enroll on WhatsApp.",
    },
    free: {
      title: "Try Our Free Courses",
      desc: "Limited time access — start your journey at no cost.",
      cta: "Get Free Access on WhatsApp",
    },
    founder: {
    ...
    urgency: [
      ...
      "Limited Time ₹300 Offer",
      "Admission Open Worldwide",
    ],
    footer: {
      rights: "All rights reserved.",
      tagline: "Authentic Islamic education, globally accessible.",
    },
    floating: "Apply Now",
    popup: {
      title: "Assalamu Alaikum! 🌙",
      body: "Reserve your seat in the ₹300 mega offer before admissions close.",
  ...
  ur: {
    ...
    hero: {
      ...
      trust: [
        "عمر کی کوئی حد نہیں",
        "مردوں اور خواتین کے لیے علیحدہ کلاسز",
        "ون آن ون اور گروپ کلاسز",
        "لائیو + ریکارڈڈ کلاسز",
        "آف لائن سرٹیفکیٹ",
      ],
    ...
    offer: {
      ...
      rows: [
        ...
        { label: "2، 3 یا 4 کورسز", price: "₹300/ماہانہ", desc: "ایک ساتھ متعدد کورسز پڑھیں۔" },
        {
          label: "تمام 9 کورسز",
          price: "₹300/ماہانہ",
          desc: "درس نظامی اور دیگر تمام کورسز تک مکمل رسائی!",
        },
      ],
      coursesListTitle: "شامل 9 کورسز:",
      coursesList: [
        "درس نظامی (عالم/عالمہ)",
        "تجوید",
        "بنیادی اردو",
        "دینیات",
        "قرأت",
    ...
    courses: {
      ...
      list: [
        {
          name: "درسِ نظامی (عالمیت)",
          desc: "مکمل عالم و عالمہ کورس۔ روزانہ 2 گھنٹے، 3 بیچ ٹائمنگ۔",
          duration: "5 سال",
          fee: "₹300 ماہانہ",
        },
        {
          name: "مفتیہ و مفتی کورس",
          desc: "تخصص فی الفقہ — عالمیت سے فارغ کے لیے۔ آن لائن لائیو کلاس۔",
          duration: "2 سال",
          fee: "₹500 ماہانہ",
        },
        {
          name: "مبلغہ کورس (خواتین)",
          desc: "خواتین کے لیے مکمل دینی تربیت — عالمہ و مفتیہ اساتذہ۔",
          duration: "2 سال",
          fee: "₹300 ماہانہ",
        },
        {
          name: "سفرِ حج و عمرہ",
          desc: "حج و عمرہ کے 14+ مسائل، Teachmint پر لائیو کلاس + ریکارڈنگ۔",
          duration: "1 ماہ",
          fee: "₹300",
        },
        {
          name: "آن لائن کڈز اسپیشل کورس",
          desc: "5–13 سال کے بچوں کے لیے قرآن، عربی، اردو، نماز، دعا، سنتیں اور ڈرائنگ۔",
          duration: "6 ماہ",
          fee: "₹350 ماہانہ",
        },
        {
          name: "تجوید کورس",
          desc: "قرآن مجید کی صحیح تلاوت مع مخارج۔",
          duration: "6 ماہ",
          fee: "₹300 ماہانہ",
        },
        {
          name: "اردو ریڈنگ و رائٹنگ",
          desc: "روزانہ 1 گھنٹہ، ہفتہ وار کوئز و انعامات، ریکارڈنگ موجود۔",
          duration: "3 ماہ",
          fee: "₹300 ماہانہ",
        },
        {
          name: "دینیات کورس",
          desc: "روزمرہ زندگی کے لیے ضروری اسلامی تعلیمات۔",
          duration: "10 ماہ",
          fee: "₹300 ماہانہ",
        },
        {
          name: "قرات کورس",
          desc: "خوبصورت قرآنی قرات و خصوصی دستار۔",
          duration: "1 سال",
          fee: "₹300 ماہانہ",
        },
        {
          name: "انگلش اسپیکنگ",
          desc: "پراعتماد انگریزی گفتگو۔",
          duration: "1–2 سال",
          fee: "₹300 ماہانہ",
        },
        {
          name: "نعت، حمد و بیان",
          desc: "نعت گوئی اور خطابت کا فن۔",
          duration: "6 ماہ",
          fee: "₹300 ماہانہ",
        },
        ...
        {
          name: "ہندوستانی آئین",
          desc: "ہر ذمہ دار مسلمان کے لیے شہری معلومات۔",
          duration: "1 سال",
          fee: "₹300 ماہانہ",
        },
      ],
    ...
    why: {
      ...
      subtitle:
        "چلیے آپ کو دکھاتے ہیں! اگر آپ مدرسہ غلامانِ مصطفی ﷺ کے کسی بھی آن لائن کورس میں داخلہ لیتے ہیں، تو آپ کو صرف تعلیم ہی نہیں، بلکہ جدید ٹیکنالوجی کے ساتھ دینی تعلیم کا ایک مکمل تجربہ ملے گا!",
      categories: {
    ...
    cert: {
      title: "آف لائن سرٹیفکیٹ حاصل کریں",
      desc: "کورس کی تکمیل پر سرٹیفکیٹ۔ قرات و عالمہ کے لیے خصوصی دستار۔",
    },
    proof: { kicker: "حقیقی نتائج", title: "ہمارے طلباء اور دستار بندی دیکھیں" },
    posters: {
      kicker: "آفیشل پوسٹرز",
      title: "کورس کے اعلانات",
      desc: "کسی بھی پوسٹر پر کلک کر کے واٹس ایپ پر داخلہ لیں۔",
    },
    free: {
      title: "ہمارے مفت کورسز آزمائیں",
      desc: "محدود وقت — اپنا سفر بغیر کسی قیمت شروع کریں۔",
      cta: "واٹس ایپ پر مفت رسائی",
    },
    founder: {
      kicker: "بانی و مہتمم",
    ...
    final: {
      title: "آج ہی اپنا دینی سفر شروع کریں",
      cta1: "ابھی واٹس ایپ کریں",
      cta2: "داخلے کی درخواست",
    },
    urgency: [
      "صرف چند سیٹیں باقی",
      "داخلے جلد بند",
      "محدود وقت ₹300 آفر",
      "داخلے دنیا بھر میں جاری",
    ],
    footer: { rights: "جملہ حقوق محفوظ ہیں۔", tagline: "مستند اسلامی تعلیم، عالمی رسائی کے ساتھ۔" },
    floating: "ابھی درخواست دیں",
    popup: {
      title: "السلام علیکم! 🌙",
      body: "داخلے بند ہونے سے پہلے ₹300 میگا آفر میں اپنی سیٹ محفوظ کریں۔",
      cta: "واٹس ایپ کریں",
      later: "بعد میں",
    },
  },
  hi: {
    ...
    hero: {
      ...
      trust: [
        "कोई आयु सीमा नहीं",
        "लड़के-लड़कियों के लिए अलग कक्षाएं",
        "वन-ऑन-वन व ग्रुप क्लासेज",
        "लाइव + रिकॉर्डेड क्लास",
        "ऑफलाइन सर्टिफिकेट",
      ],
    ...
    offer: {
      ...
      rows: [
        ...
        { label: "2, 3 या 4 कोर्स", price: "₹300/माह", desc: "एक साथ कई कोर्सेस पढ़ें।" },
        {
          label: "सभी 9 कोर्स",
          price: "₹300/माह",
          desc: "दर्स ए निज़ामी और अन्य सभी कोर्सेस तक पूर्ण पहुंच!",
        },
      ],
      coursesListTitle: "शामिल 9 कोर्सेस:",
      coursesList: [
        "दर्स-ए-निज़ामी (आलिम/आलिमा)",
        "तजवीद",
        "बुनियादी उर्दू",
        "दीनियात",
        "किरत",
    ...
    courses: {
      ...
      list: [
        {
          name: "दर्स-ए-निज़ामी (आलिमियत)",
          desc: "पूर्ण आलिम व आलिमा कोर्स। दैनिक 2 घंटे, 3 बैच टाइमिंग।",
          duration: "5 वर्ष",
          fee: "₹300/माह",
        },
        {
          name: "मुफ्तिया व मुफ्ती कोर्स",
          desc: "तख़स्सुस फिल फिक़्ह — आलिमियत के बाद। ऑनलाइन लाइव क्लास।",
          duration: "2 वर्ष",
          fee: "₹500/माह",
        },
        {
          name: "मुबल्लिग़ा कोर्स (महिलाएं)",
          desc: "महिलाओं के लिए संपूर्ण दीनी प्रशिक्षण — आलिमा व मुफ्तिया शिक्षिकाएं।",
          duration: "2 वर्ष",
          fee: "₹300/माह",
        },
        {
          name: "सफ़र-ए-हज व उमरा",
          desc: "हज व उमरा के 14+ मसाइल। Teachmint पर लाइव क्लास + रिकॉर्डिंग।",
          duration: "1 माह",
          fee: "₹300",
        },
        {
          name: "ऑनलाइन किड्स स्पेशल कोर्स",
          desc: "5–13 वर्ष के बच्चों के लिए क़ुरआन, अरबी, उर्दू, नमाज़, दुआ, सुन्नतें व ड्रॉइंग।",
          duration: "6 माह",
          fee: "₹350/माह",
        },
        {
          name: "तजवीद कोर्स",
          desc: "पवित्र क़ुरआन की शुद्ध तिलावत मख़ारिज के साथ।",
          duration: "6 माह",
          fee: "₹300/माह",
        },
        {
          name: "उर्दू रीडिंग व राइटिंग",
          desc: "दैनिक 1 घंटा, साप्ताहिक क्विज़ व पुरस्कार, रिकॉर्डिंग उपलब्ध।",
          duration: "3 माह",
          fee: "₹300/माह",
        },
        {
          name: "दीनियात कोर्स",
          desc: "रोज़मर्रा की इस्लामी शिक्षा।",
          duration: "10 माह",
          fee: "₹300/माह",
        },
        {
          name: "क़िरात कोर्स",
          desc: "सुंदर क़ुरआनी क़िरात व विशेष दस्तार।",
          duration: "1 वर्ष",
          fee: "₹300/माह",
        },
        {
          name: "इंग्लिश स्पीकिंग",
          desc: "आत्मविश्वास से अंग्रेज़ी बोलना।",
          duration: "1–2 वर्ष",
          fee: "₹300/माह",
        },
        { name: "नात, हम्द व बयान", desc: "नात व खुत्बा कला।", duration: "6 माह", fee: "₹300/माह" },
        {
          name: "ख़त्मे नुबुव्वत ﷺ",
          desc: "ख़त्मे नुबुव्वत का संरक्षण।",
          duration: "6 माह",
          fee: "₹300/माह",
        },
        {
          name: "भारतीय संविधान",
          desc: "हर ज़िम्मेदार मुस्लिम के लिए नागरिक ज्ञान।",
          duration: "1 वर्ष",
          fee: "₹300/माह",
        },
      ],
    ...
    why: {
      ...
      subtitle:
        "चलिए आपको दिखाते हैं! अगर आप मदरसा ए गुलामान ए मुस्तफा ﷺ के किसी भी ऑनलाइन कोर्स में एडमिशन लेते हैं, तो आपको सिर्फ शिक्षा ही नहीं, बल्कि आधुनिक तकनीक के साथ दीनी तालीम का एक मुकम्मल लर्निंग एक्सपीरियंस मिलेगा!",
      categories: {
    ...
    cert: {
      title: "ऑफलाइन सर्टिफिकेट प्राप्त करें",
      desc: "कोर्स पूरा होने पर मान्यता प्राप्त सर्टिफिकेट। क़िरात व आलिमा के लिए विशेष दस्तार समारोह।",
    },
    proof: { kicker: "वास्तविक परिणाम", title: "हमारे छात्र और दस्तार समारोह देखें" },
    posters: {
      kicker: "आधिकारिक पोस्टर",
      title: "कोर्स घोषणाएं",
      desc: "किसी भी पोस्टर पर क्लिक करके व्हाट्सएप पर एडमिशन लें।",
    },
    free: {
      title: "हमारे फ्री कोर्स आज़माएं",
      desc: "सीमित समय — बिना शुल्क अपनी यात्रा शुरू करें।",
      cta: "व्हाट्सएप पर मुफ्त एक्सेस",
    },
    founder: {
    ...
    final: {
      title: "आज ही अपनी दीनी यात्रा शुरू करें",
      cta1: "अभी व्हाट्सएप करें",
      cta2: "एडमिशन के लिए आवेदन",
    },
    urgency: [
      "केवल कुछ सीटें शेष",
      "एडमिशन जल्द बंद",
      "सीमित समय ₹300 ऑफर",
      "एडमिशन वर्ल्डवाइड ओपन",
    ],
    footer: { rights: "सर्वाधिकार सुरक्षित।", tagline: "प्रामाणिक इस्लामी शिक्षा, वैश्विक पहुंच।" },
    floating: "अभी आवेदन करें",
    popup: {
      title: "अस्सलामु अलैकुम! 🌙",
      body: "एडमिशन बंद होने से पहले ₹300 मेगा ऑफर में अपनी सीट आरक्षित करें।",
      cta: "व्हाट्सएप करें",
      later: "बाद में",
    },
  },
